  ...
  Future<void> _pickImage() async {
    try {
      final XFile? pickedFile = await _picker.pickImage(
        ...
        imageQuality:
            80, // Kompres kualitas gambar ke 80% biar hemat storage Laravel
      );
  ...
  Future<void> _saveTopping() async {
    ...
    if (_nameController.text.trim().isEmpty ||
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          ...
          content: Text("Semua data form wajib diisi bang!"),
        ),
      );
      return;
    }
    ...
    try {
      ...
      final Map<String, dynamic> toppingData = {
        'id_kategori_topping':
            _selectedCategoryId, // validator Laravel: id_kategori_topping
        'nama_topping': _nameController.text
            .trim(), // validator Laravel: nama_topping
        'harga': hargaInt,
        'stok': stokInt,
      ...
      if (success) {
        ...
        await _toppingController.fetchToppingByCategory(
          _toppingController.selectedCategoryId.value,
        );
        ...
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(
              ...
              content: Text("Topping baru berhasil ditambahkan! 🔥"),
            ),
          );
                              ...
                              child: _toppingController.listCategories.isEmpty
                                  ...
                                  : DropdownButtonHideUnderline(
                                      child: DropdownButton<int>(
                                        value:
                                            _toppingController.listCategories
                                                .any(
                                                  (cat) =>
                                                      cat.id ==
                                                      _selectedCategoryId,
                                        ...
                                        items: _toppingController.listCategories
                                            .map((cat) {
