              ...
              child: Row(
                ...
                children: [
                  ...
                  Image.asset('assets/images/Logo2.png', height: 36,
                    errorBuilder: (_, __, ___) => const Text('Say!',
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: ClipRRect(
                        ...
                        child: Stack(
                          children: [
                            Image.asset('assets/images/banner_bg.jpg',
                              height: 130, width: double.infinity, fit: BoxFit.cover,
                              errorBuilder: (_, __, ___) => Container(
                                height: 130, color: Colors.black87),
                            ),
                            Container(
                              height: 130,
                            ...
                            child: Row(
                              children: [
                                ...
                                OutlinedButton(
                                  ...
                                  child: const Text('Add', style: TextStyle(color: Color(0xFFE53935), fontWeight: FontWeight.bold)),
                                ),
                              ],
                            ),
                          ),
