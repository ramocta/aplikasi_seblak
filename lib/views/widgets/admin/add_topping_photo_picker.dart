...
class AddToppingPhotoPicker extends StatelessWidget {
  final File? imageFile;
  final Uint8List? webImageBytes;
  final VoidCallback onPickImage;

  const AddToppingPhotoPicker({
    super.key,
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          image: webImageBytes != null
              ? DecorationImage(image: MemoryImage(webImageBytes!), fit: BoxFit.cover)
              : (imageFile != null ? DecorationImage(image: FileImage(imageFile!), fit: BoxFit.cover) : null),
        ),
